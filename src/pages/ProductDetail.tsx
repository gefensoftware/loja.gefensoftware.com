...
const ProductDetail = () => {
  const { id_product, id_enterprise } = useParams();
  ...
  if (!product) {
    return (
      <div className="text-center py-12">
        ...
        <Link to={`/enterprise/${id_enterprise}`} className="text-primary hover:text-primary/90 flex items-center justify-center">
    ...
    <div className="flex justify-center items-center bg-white">
      <div className=" overflow-hidden max-w-6xl">
        <div className="p-6  border-b ">
          <Link to={`/enterprise/${id_enterprise}`} className="text-primary hover:text-primary/90 flex items-center mb-4">
            <ArrowLeft className="w-4 h-4 mr-2" />
            Voltar para a lista de produtos
          </Link>
              ...
              <dl className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <dd className="text-gray-900 font-medium">
                    {/* {mockCategories.find(c => c.id_category === product.id_category)?.name} */}
                  </dd>
                </div>
                <div className="flex justify-between">
